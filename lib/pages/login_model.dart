                      ...
                      children: [
                        Stack(
                          ...
                          children:[
                            const Align(
                              ...
                              child:Text('Just a minute', style:TextStyle( color:ColorConst.primaryText, fontSize: 24, fontWeight: FontWeight.w600)),
                            ),
                            Align(
                        ...
                        const Stack(
                          ...
                          children: [
                            Align(
                              alignment: Alignment.centerLeft,
                              child: Text('Before you start curating magic,tell us who you are', 
                                      style:TextStyle(
